...
class BackgroundContainer extends StatelessWidget {
  ...
  String _getBackgroundImage(int level) {
    ...
    switch (bgNumber) {
      case 1: return 'assets/bg.png';
      case 2: return 'assets/bg2.png';
      case 3: return 'assets/bg3.png';
      case 4: return 'assets/bg4.png';
      case 5: return 'assets/bg5.png';
      case 6: return 'assets/bg6.png';
      case 7: return 'assets/bg7.png';
      case 8: return 'assets/bg8.png';
      case 9: return 'assets/bg9.png';
      case 10: return 'assets/bg10.png';
      default: return 'assets/bg.png';
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Try to get provider, fallback to default if not found
    final gameLevelProvider = Provider.of<GameLevelProvider?>(context, listen: false);
    final currentLevel = gameLevelProvider?.currentLevel ?? 1;
